                            ...
                            <form id="update_{{ $primaryCategory->id }}" action="{{ route('admin.categories.update', ['id' => $primaryCategory->id]) }}" method="POST">
                                ...
                                <label class="text-sm text-gray-600">セカンダリーカテゴリー情報</label>
                                        <div class="overflow-x-auto mb-20">
                                            ...
                                            @if (count($secondaryCategories) > 0)
                                                <tbody class="text-gray-700">
                                                    ...
                                                    @endforeach
                                            @else
                                                <p class="text-left mb-4">登録済みSeconadaryCatergory情報はありません。</p>
                                            @endif
                                                    {{-- 新規セカンダリーカテゴリーの追加行 --}}
                                        ...
                                        <div class="flex justify-end">
                                            ...
                                            <a href="#" data-id="{{ $primaryCategory->id }}" onclick="updatePost(this)" class="text-white bg-lime-500 border-0 py-2 px-8 focus:outline-none hover:bg-lime-400 rounded text-lg">更新する</a>
                                        </div>
                            </form>
                        </div>
                    </section>
