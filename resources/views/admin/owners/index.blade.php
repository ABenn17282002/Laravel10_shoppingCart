                                ...
                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3">
                                                <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id ])}}'" class="text-white bg-indigo-400 border-0 px-4 py-3 focus:outline-none hover:bg-indigo-500 rounded ">編集</button>
                                            </td>
                                            {{-- 削除用ボタン --}}
