                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="md:px-4 py-3">
                                                <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id ])}}'" class="text-white bg-indigo-400 border-0 px-4 py-2 focus:outline-none hover:bg-indigo-500 rounded">編集</button>
                                            </td>
                                            {{-- 削除用ボタン --}}
